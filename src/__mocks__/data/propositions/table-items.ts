...
const npTableDataIEandII: NaturalProofsTableItem[] = [
  {
    level: 0,
    id: '8221c504-97ac-0b51-a57f-3afda8fc453c',
    step: 1,
    rawInput: 'p&r',
    expression: [
      {
  ...
  {
    level: 1,
    id: 'a9c4bd87-65f1-1936-c2ed-f60fedd7fe52',
    step: 2,
    rawInput: 'p&r=>q',
    expression: [
      {
    ...
    assumptionId: '19b17c6e-41d9-3466-8c9a-04baf38e3f49',
  },
  {
    level: 1,
    step: 3,
    assumptionId: '19b17c6e-41d9-3466-8c9a-04baf38e3f49',
    id: 'a2d6470c-e54b-eee0-6a40-8c264c8f3a7d',
    rawInput: 'p&r, p&r=>q',
    formulaBase: NPFormulaBase.IE,
    dependentOn: ['8221c504-97ac-0b51-a57f-3afda8fc453c', 'a9c4bd87-65f1-1936-c2ed-f60fedd7fe52'],
    comment: {
      en: 'IE: 1, 2',
      ru: 'УИ: 1, 2',
    },
  ...
  },
  {
    ...
    step: 4,
    assumptionId: null,
    id: '0510c76e-c34a-7e9f-3e1b-ec52e8cdb0fb',
    rawInput: 'p&r=>q, p&r, p&r=>q',
    formulaBase: NPFormulaBase.II,
    dependentOn: ['a9c4bd87-65f1-1936-c2ed-f60fedd7fe52', 'a2d6470c-e54b-eee0-6a40-8c264c8f3a7d'],
    comment: {
      en: 'II: 2, 3',
      ru: 'ВИ: 2, 3',
    },
...
const npIEandIItoXML =
  '<?xml version="1.0" encoding="UTF-8" standalone="no" ?>\n<propositionsNaturalProof><tableItem><id>8221c504-97ac-0b51-a57f-3afda8fc453c</id><step>1</step><rawInput>p&q</rawInput><comment><en>Premise</en><ru>Посылка</ru></comment><dependentOn></dependentOn><propositionalFormula><operator>AND</operator><values><propositionalFormula><operator>VAR</operator><values>P</values></propositionalFormula><propositionalFormula><operator>VAR</operator><values>Q</values></propositionalFormula></values></propositionalFormula><propositionalExpression><propositionalSymbol><input>(</input><type>parentheses</type><position>0</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>1</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>p</input><type>variable</type><position>2</position><representation>P</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>3</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>&</input><type>operator</type><position>4</position><representation>∧</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>5</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>q</input><type>variable</type><position>6</position><representation>Q</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>7</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>8</position><representation>)</representation></propositionalSymbol></propositionalExpression><propositionalExpression><propositionalSymbol><input>P</input><type>variable</type><position>0</position><representation>P</representation></propositionalSymbol><propositionalSymbol><input>&</input><type>operator</type><position>1</position><representation>∧</representation></propositionalSymbol><propositionalSymbol><input>Q</input><type>variable</type><position>2</position><representation>Q</representation></propositionalSymbol></propositionalExpression></tableItem><tableItem><id>a9c4bd87-65f1-1936-c2ed-f60fedd7fe52</id><step>2</step><rawInput>p&q=>r</rawInput><comment><en>Assumption</en><ru>Гипотеза</ru></comment><dependentOn></dependentOn><propositionalFormula><operator>IMPLIES</operator><values><propositionalFormula><operator>AND</operator><values><propositionalFormula><operator>VAR</operator><values>P</values></propositionalFormula><propositionalFormula><operator>VAR</operator><values>Q</values></propositionalFormula></values></propositionalFormula><propositionalFormula><operator>VAR</operator><values>R</values></propositionalFormula></values></propositionalFormula><propositionalExpression><propositionalSymbol><input>(</input><type>parentheses</type><position>0</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>1</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>2</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>p</input><type>variable</type><position>3</position><representation>P</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>4</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>&</input><type>operator</type><position>5</position><representation>∧</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>6</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>q</input><type>variable</type><position>7</position><representation>Q</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>8</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>9</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>=></input><type>operator</type><position>10</position><representation>⇒</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>11</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>r</input><type>variable</type><position>12</position><representation>R</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>13</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>14</position><representation>)</representation></propositionalSymbol></propositionalExpression><propositionalExpression><propositionalSymbol><input>(</input><type>parentheses</type><position>0</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>P</input><type>variable</type><position>1</position><representation>P</representation></propositionalSymbol><propositionalSymbol><input>&</input><type>operator</type><position>2</position><representation>∧</representation></propositionalSymbol><propositionalSymbol><input>Q</input><type>variable</type><position>3</position><representation>Q</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>4</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>=></input><type>operator</type><position>5</position><representation>⇒</representation></propositionalSymbol><propositionalSymbol><input>R</input><type>variable</type><position>6</position><representation>R</representation></propositionalSymbol></propositionalExpression></tableItem><tableItem><id>a2d6470c-e54b-eee0-6a40-8c264c8f3a7d</id><step>3</step><rawInput>p&q, p&q=>r</rawInput><comment><en>IE: 1, 2</en><ru>УИ: 1, 2</ru></comment><dependentOn><id>8221c504-97ac-0b51-a57f-3afda8fc453c</id><id>a9c4bd87-65f1-1936-c2ed-f60fedd7fe52</id></dependentOn><propositionalFormula><operator>VAR</operator><values>R</values></propositionalFormula><propositionalExpression><propositionalSymbol><input>(</input><type>parentheses</type><position>0</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>R</input><type>variable</type><position>1</position><representation>R</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>2</position><representation>)</representation></propositionalSymbol></propositionalExpression><propositionalExpression><propositionalSymbol><input>R</input><type>variable</type><position>0</position><representation>R</representation></propositionalSymbol></propositionalExpression></tableItem><tableItem><id>0510c76e-c34a-7e9f-3e1b-ec52e8cdb0fb</id><step>4</step><rawInput>p&q=>r, p&q, p&q=>r</rawInput><comment><en>II: 2, 3</en><ru>ВИ: 2, 3</ru></comment><dependentOn><id>a9c4bd87-65f1-1936-c2ed-f60fedd7fe52</id><id>a2d6470c-e54b-eee0-6a40-8c264c8f3a7d</id></dependentOn><propositionalFormula><operator>IMPLIES</operator><values><propositionalFormula><operator>IMPLIES</operator><values><propositionalFormula><operator>AND</operator><values><propositionalFormula><operator>VAR</operator><values>P</values></propositionalFormula><propositionalFormula><operator>VAR</operator><values>Q</values></propositionalFormula></values></propositionalFormula><propositionalFormula><operator>VAR</operator><values>R</values></propositionalFormula></values></propositionalFormula><propositionalFormula><operator>VAR</operator><values>R</values></propositionalFormula></values></propositionalFormula><propositionalExpression><propositionalSymbol><input>(</input><type>parentheses</type><position>0</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>1</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>2</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>3</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>P</input><type>variable</type><position>4</position><representation>P</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>5</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>&</input><type>operator</type><position>6</position><representation>∧</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>7</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>Q</input><type>variable</type><position>8</position><representation>Q</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>9</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>10</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>=></input><type>operator</type><position>11</position><representation>⇒</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>12</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>R</input><type>variable</type><position>13</position><representation>R</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>14</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>15</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>=></input><type>operator</type><position>16</position><representation>⇒</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>17</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>R</input><type>variable</type><position>18</position><representation>R</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>19</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>20</position><representation>)</representation></propositionalSymbol></propositionalExpression><propositionalExpression><propositionalSymbol><input>(</input><type>parentheses</type><position>0</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>(</input><type>parentheses</type><position>1</position><representation>(</representation></propositionalSymbol><propositionalSymbol><input>P</input><type>variable</type><position>2</position><representation>P</representation></propositionalSymbol><propositionalSymbol><input>&</input><type>operator</type><position>3</position><representation>∧</representation></propositionalSymbol><propositionalSymbol><input>Q</input><type>variable</type><position>4</position><representation>Q</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>5</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>=></input><type>operator</type><position>6</position><representation>⇒</representation></propositionalSymbol><propositionalSymbol><input>R</input><type>variable</type><position>7</position><representation>R</representation></propositionalSymbol><propositionalSymbol><input>)</input><type>parentheses</type><position>8</position><representation>)</representation></propositionalSymbol><propositionalSymbol><input>=></input><type>operator</type><position>9</position><representation>⇒</representation></propositionalSymbol><propositionalSymbol><input>R</input><type>variable</type><position>10</position><representation>R</representation></propositionalSymbol></propositionalExpression></tableItem></propositionsNaturalProof>';
